...
SLIDES.push({
	...
	onstart: function(self){
		...
		// Words on top & bottom
		self.add({
			id:"topWords", type:"TextBox", text_id:"oneoff5_0_top",
			x:130, y:10, width:700, height:100, align:"center"
		});
		self.add({
			id:"btmWords", type:"TextBox", text_id:"oneoff5_0_btm",
	...
	onstart: function(self){
		...
		// Payoff
		o.iterated.oneoff5Highlight1(_.answer);

		// Text
		var t = o.topWords;
		var b = o.btmWords;
		if(_.answer=="COOPERATE"){
			t.setText(Words.get("oneoff5_1_cooperated")+"<br>"+Words.get("oneoff5_1_top"));
		}else{
			t.setText(Words.get("oneoff5_1_cheated")+"<br>"+Words.get("oneoff5_1_top"));
		}
		b.setTextID("oneoff5_1_btm");
	...
	onstart: function(self){
		...
		// Payoff
		o.iterated.oneoff5Highlight2(_.answer);

		// Text
		var t = o.topWords;
		if(_.answer=="COOPERATE"){
			t.setText(Words.get("oneoff5_2_cooperated")+"<br>"+Words.get("oneoff5_2_top"));
		}else{
			t.setText(Words.get("oneoff5_2_cheated")+"<br>"+Words.get("oneoff5_2_top"));
		}
		self.add({
			id:"btmWords", type:"TextBox", text_id:"oneoff5_2_btm",
